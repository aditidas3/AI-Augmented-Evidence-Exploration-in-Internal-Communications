...
The pipeline runs all five operators in sequence (ALIGN → TRACE → CONFLICT → CONSTRUCT → EXPLAIN) and logs everything automatically. No manual steps between operators.
...
```
project/
  pipeline.py            # pipeline runner — entry point
